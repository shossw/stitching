...
Mat makePanorama(Mat matLeftImage, Mat matRightImage) {
	...
	//Gray 이미지로 변환
	cvtColor(matLeftImage, matGrayLImage, COLOR_BGR2GRAY);
	cvtColor(matRightImage, matGrayRImage, COLOR_BGR2GRAY);
	...
	Mat HomoMatrix = findHomography(scene, obj, RANSAC);
...
int main()
{
	...
	matImage1 = imread("/home/sho/stitching example/right.jpg", IMREAD_COLOR);
	matImage2 = imread("/home/sho/stitching example/center.jpg", IMREAD_COLOR);
	matImage3 = imread("/home/sho/stitching example/left.jpg", IMREAD_COLOR);
	...
	imwrite("/home/sho/stitching example/result.jpg", result1);
